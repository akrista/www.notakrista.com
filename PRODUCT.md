...
Future-facing (not built now): external users can register, with the Filament panel used to manage them.
...
**An engineer who ships in public, with a real life.** Every screen reinforces that line. The work is real (bizkit, open-source, old projects, a site that is itself a working product). The life is real (Wakatime, Steam, RetroAchievements, donations, wishlist, earthquake relief, family). The site refuses to be a credential dressed up as a person.
...
- **Belief ladder**, in order:
    1. This is a real person, not a brand.
    2. They ship working software, not prototypes.
    3. They have a life outside the terminal — gaming, family, causes.
    4. They're worth contacting.
- **Proof on hand**:
    - **GitHub / bizkit / open-source work** — the bizkit starter kit (this codebase) and any external repos the user maintains.
    - **Past work / case studies** — older projects (e.g. the todoticket calculator) and any shipped client work worth surfacing.
    - **Testimonials / recommendations / press** — references the user already has.
    - **Live signals** — Wakatime, Steam, RetroAchievements. The site pulls and surfaces these as evidence the user is alive and shipping.
...
- **A corporate resume / LinkedIn-style profile.** No "Hi, I'm John, passionate about..." copy, no stock photo of the user pointing at a whiteboard, no Skills grid, no endorsements row.
- **A SaaS / indie hacker landing page.** No big gradient metrics, no eyebrow kickers above every section, no "ship faster" energy, no testimonials marquee.
- **A default-Laravel / Bootstrap-era portfolio.** No "Let's get started" placeholder, no two-card split, no logo wall.
- **A maximalist dev-ornament portfolio.** No animated background grids, no feTurbulence paper grain, no decoration-on-decoration.
