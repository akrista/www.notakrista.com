...
<template>
    <Head title="Welcome - Vue">
        <link rel="preconnect" href="https://rsms.me/" />
        <link rel="stylesheet" href="https://rsms.me/inter/inter.css" />
    </Head>
    <nav class="fixed top-4 right-4 z-50 flex flex-wrap items-center gap-1.5">
        <a
            href="/"
            class="rounded-full border border-[#e3e3e0] bg-white px-3 py-1 text-[11px] font-medium text-[#706f6c] transition-colors hover:border-[#FB70A9] hover:text-[#FB70A9] dark:border-[#3E3E3A] dark:bg-[#161615] dark:text-[#A1A09A] dark:hover:border-[#EDEDEC] dark:hover:text-[#EDEDEC]"
        >
            Livewire
        </a>
        <a
            href="/react"
            class="rounded-full border border-[#e3e3e0] bg-white px-3 py-1 text-[11px] font-medium text-[#706f6c] transition-colors hover:border-[#61DAFB] hover:text-[#61DAFB] dark:border-[#3E3E3A] dark:bg-[#161615] dark:text-[#A1A09A]"
        >
            React
        </a>
        <span
            class="rounded-full border border-[#42b883] bg-[#42b883] px-3 py-1 text-[11px] font-medium text-white"
        >
            Vue
        </span>
        <a
            href="/svelte"
            class="rounded-full border border-[#e3e3e0] bg-white px-3 py-1 text-[11px] font-medium text-[#706f6c] transition-colors hover:border-[#ff3e00] hover:text-[#ff3e00] dark:border-[#3E3E3A] dark:bg-[#161615] dark:text-[#A1A09A]"
        >
            Svelte
        </a>
        <a
    ...
    >
        ...
        >
            ...
            >
                <div
                    class="flex-1 rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:px-20 lg:py-12 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]"
                >
                    ...
                    <span
                        class="block text-[11px] text-[#706f6c] dark:text-[#A1A09A]"
                    >
                        This page is powered by
                        <span class="font-semibold text-[#42b883]"
                            >Vue 3 + Inertia.js</span
                        >
                    </span>
                    <ul class="mt-4 flex gap-3 text-sm leading-normal">
                        <li>
                            <a
