...
export default function Welcome() {
    return (
        <>
            ...
            {/* Framework nav — fixed top-right */}
            <nav className="fixed top-4 right-4 z-50 flex flex-wrap items-center gap-1.5">
                <a
                    href="/"
                    className="rounded-full border border-[#e3e3e0] bg-white px-3 py-1 text-[11px] font-medium text-[#706f6c] transition-colors hover:border-[#FB70A9] hover:text-[#FB70A9] dark:border-[#3E3E3A] dark:bg-[#161615] dark:text-[#A1A09A] dark:hover:border-[#EDEDEC] dark:hover:text-[#EDEDEC]"
                >
                    Livewire
                </a>
                <span className="rounded-full border border-[#61DAFB] bg-[#61DAFB] px-3 py-1 text-[11px] font-medium text-black">
                    React
                </span>
                <a
                    href="/vue"
                    className="rounded-full border border-[#e3e3e0] bg-white px-3 py-1 text-[11px] font-medium text-[#706f6c] transition-colors hover:border-[#42b883] hover:text-[#42b883] dark:border-[#3E3E3A] dark:bg-[#161615] dark:text-[#A1A09A]"
                >
                    Vue
                </a>
                <a
                    href="/svelte"
                    className="rounded-full border border-[#e3e3e0] bg-white px-3 py-1 text-[11px] font-medium text-[#706f6c] transition-colors hover:border-[#ff3e00] hover:text-[#ff3e00] dark:border-[#3E3E3A] dark:bg-[#161615] dark:text-[#A1A09A]"
                >
                    Svelte
                </a>
                <a
                    href="/admin"
                    className="rounded-full border border-[#e3e3e0] bg-white px-3 py-1 text-[11px] font-medium text-[#706f6c] transition-colors hover:border-[#1b1b18] hover:text-[#1b1b18] dark:border-[#3E3E3A] dark:bg-[#161615] dark:text-[#A1A09A] dark:hover:border-[#EDEDEC] dark:hover:text-[#EDEDEC]"
                >
                    Admin
                </a>
            </nav>
            ...
            <div className="flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] lg:justify-center lg:p-8 dark:bg-[#0a0a0a]">
                <div className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:px-20 lg:py-12 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                            ...
                            <p className="mb-4 text-[11px] text-[#706f6c] dark:text-[#A1A09A]">
                                This page is powered by{' '}
                                <span className="font-semibold text-[#61DAFB] dark:text-[#61DAFB]">
                                    React + Inertia.js
                                </span>
                            </p>
