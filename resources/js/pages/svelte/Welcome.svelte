<script lang="ts">
    import { inertia as _inertia } from '@inertiajs/svelte';
</script>
...
<nav class="fixed top-4 right-4 z-50 flex flex-wrap items-center gap-1.5">
    <a
        href="/"
        class="rounded-full border border-[#e3e3e0] bg-white px-3 py-1 text-[11px] font-medium text-[#1b1b18] transition-colors hover:border-[#FB70A9] hover:text-[#FB70A9] dark:border-[#3E3E3A] dark:bg-[#161615] dark:text-[#EDEDEC] dark:hover:border-[#EDEDEC] dark:hover:text-[#EDEDEC]"
    >
        Livewire
    </a>
    <a
        href="/react"
        class="rounded-full border border-[#e3e3e0] bg-white px-3 py-1 text-[11px] font-medium text-[#1b1b18] transition-colors hover:border-[#61DAFB] hover:text-[#61DAFB] dark:border-[#3E3E3A] dark:bg-[#161615] dark:text-[#EDEDEC]"
    >
        React
    </a>
    <a
        href="/vue"
        class="rounded-full border border-[#e3e3e0] bg-white px-3 py-1 text-[11px] font-medium text-[#1b1b18] hover:bg-[#f5f5f3] dark:border-[#3E3E3A] dark:bg-[#161615] dark:text-[#EDEDEC] dark:hover:bg-[#1e1e1c]"
    >
        Vue
    </a>
    <span
...
>
    ...
    >
        ...
        >
            <div
                class="flex-1 rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 text-[13px] leading-5 shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:px-20 lg:py-12 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]"
            >
                ...
                >
                    This page is powered by <span
                        class="font-semibold text-[#ff3e00]"
                        >Svelte + Inertia.js</span
                    >
                </span>
